...
export const RecommendedStore = ({ store }: RecommendedStoreProps) => {
  return (
    <div className="px-4 mt-8">
      <h2 className="font-semibold mb-4 text-muted-foreground dark:text-muted-foreground">Migliore opzione:</h2>
      <Card className="border-2 border-green-200 dark:border-green-800 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 shadow-lg rounded-2xl overflow-hidden">
        <CardContent className="p-6">
          <div className="mb-6">
            <h3 className="font-bold text-2xl text-green-800 dark:text-green-200 mb-2">{store.name}</h3>
          ...
          <Button className="w-full bg-green-600 hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-700 rounded-xl py-3 h-12 font-semibold shadow-md hover:shadow-lg transition-all duration-200">
