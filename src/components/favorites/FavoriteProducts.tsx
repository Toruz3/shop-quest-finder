...
export const FavoriteProducts = ({
  ...
  return <>
      <div className="flex justify-between items-center mb-3">
        ...
        <Button variant="outline" size="sm" className="h-8 text-xs bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100" onClick={() => setShowProductDialog(true)}>
