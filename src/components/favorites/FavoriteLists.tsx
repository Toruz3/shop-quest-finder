                ...
                <div className="p-4">
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {list.items.slice(0, 5).map((item, idx) => (
                      <Badge key={idx} variant="outline" className="bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-gray-600 text-xs px-2 py-1 rounded-full">
                        {item}
                      </Badge>
                    ))}
                    {list.items.length > 5 && (
                      <Badge variant="outline" className="bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 border-gray-200 dark:border-gray-600 text-xs px-2 py-1 rounded-full">
                        +{list.items.length - 5}
                      </Badge>
                    )}
                  </div>
