          ...
          <Tabs defaultValue="lists" value={activeTab} onValueChange={setActiveTab} className="mb-4">
            ...
            <TabsContent value="lists" className="mt-4">
              ...
              {filteredLists.length > 0 ? <div className="space-y-3">
                      ...
                      <Card className="overflow-hidden border border-neutral-200 hover:border-primary-200 transition-all duration-300 shadow-sm hover:shadow-md">
                        <div className="p-3">
                          ...
                          <div className="flex flex-wrap gap-1 mt-2">
                            {list.items.slice(0, 5).map((item, idx) => <Badge key={idx} variant="outline" className="bg-primary-50 text-primary-700 border-primary-200 text-xs">
                                {item}
                              </Badge>)}
                            {list.items.length > 5 && <Badge variant="outline" className="bg-neutral-100 text-neutral-600 border-neutral-200 text-xs">
                                +{list.items.length - 5}
                              </Badge>}
                          </div>
                        </div>
                ...
                </div> : <Card className="p-6 text-center border-dashed border-2">
