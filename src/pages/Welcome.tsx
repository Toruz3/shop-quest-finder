...
const Welcome = () => {
  ...
  return (
    <motion.div
      className="min-h-screen w-full flex flex-col justify-center items-center bg-gradient-to-tr from-primary-50 via-primary-200 to-accent-100 overflow-hidden relative"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="relative z-10 flex flex-col-reverse md:flex-row items-center md:items-start gap-6 md:gap-16 px-4 pt-10 pb-6 md:py-16 w-full max-w-5xl">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto items-center">
            <Button
              className="px-10 py-4 btn-primary rounded-lg font-bold text-lg shadow-lg transition hover:scale-[1.04] hover:bg-primary/90 w-full sm:w-auto"
              size="lg"
            ...
            <Button
              className="px-10 py-4 rounded-lg font-bold text-lg shadow-lg bg-accent text-white hover:brightness-105 hover:scale-[1.03] w-full sm:w-auto"
              size="lg"
              variant="secondary"
        ...
        <motion.div
          className="flex-shrink-0 mb-7 md:mb-0"
        ...
        >
          <img
            src={WELCOME_IMAGE}
            alt="Benvenuto Shop Quest"
            className="rounded-2xl shadow-card w-[320px] h-[220px] object-cover border-4 border-primary-100 bg-neutral-100 animate-fade-in"
            width={320}
            height={220}
            loading="lazy"
            draggable={false}
      ...
      >
        <ChevronRight className="rotate-90 text-primary-400 w-8 h-8 opacity-70" />
        <span className="text-sm text-primary-500 mt-1">Scorri in alto per accedere</span>
      </motion.div>
    </motion.div>
  );
};
