          ...
          <form onSubmit={handleResetPassword} className="space-y-3">
            <div className="space-y-1">
              ...
              <Input
                ...
                required
                className="border-gray-300 focus:border-primary/30 focus:ring focus:ring-primary/20 h-9"
              />
            ...
            <div className="flex gap-2 pt-2">
              ...
              <Button
                type="submit"
                className="flex-1 bg-gradient-to-r from-primary to-accent hover:opacity-90 text-white font-medium py-2 h-10"
                disabled={isLoading}
              >
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm glass-effect p-6 rounded-xl shadow-lg">
        ...
        <div className="tabs flex border-b mb-4">
          <div 
            className={`w-1/2 text-center py-2 cursor-pointer ${isLogin ? 'font-medium text-primary' : 'text-gray-600'}`}
